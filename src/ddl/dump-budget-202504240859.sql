...
--
-- Dumping data for table `action_plan_status`
--

LOCK TABLES `action_plan_status` WRITE;
/*!40000 ALTER TABLE `action_plan_status` DISABLE KEYS */;
/*!40000 ALTER TABLE `action_plan_status` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `action_plan_target`
--

LOCK TABLES `action_plan_target` WRITE;
/*!40000 ALTER TABLE `action_plan_target` DISABLE KEYS */;
/*!40000 ALTER TABLE `action_plan_target` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-04-24  8:59:02
